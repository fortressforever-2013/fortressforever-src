...
protected:
	...
	virtual void OnCommand( const char *command );	// BREAKINBENNY: TEMP, because I wasn't up for remaking FF's team menu to use the new command system. This is a temporary fix to get it working again!
