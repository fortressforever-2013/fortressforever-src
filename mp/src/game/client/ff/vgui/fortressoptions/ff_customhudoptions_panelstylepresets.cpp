...
namespace vgui
{
	CFFCustomHudPanelStylePresets::CFFCustomHudPanelStylePresets(Panel* parent, char const* panelName, char const* pszComboBoxName) : BaseClass(parent, panelName, pszComboBoxName, ARRANGEMENTPRESET_FILE)
	{
		...
		m_pHeaderTextSize->SetRange(1, QUANTITYPANELTEXTSIZES);
		...
		m_pPanelType = new ComboBox(m_pPanel, "PanelTypeCombo", 3, false);
		kv = new KeyValues("PT");
		kv->SetInt("Round", FFQuantityPanel::CORNERS_ROUND);
		m_pPanelType->AddItem("#GameUI_Round", kv);
		kv->deleteThis();
		kv = new KeyValues("PT");
		kv->SetInt("Square", FFQuantityPanel::CORNERS_SQUARE);
		m_pPanelType->AddItem("#GameUI_Square", kv);
		kv->deleteThis();
		m_pPanelType->ActivateItemByRow(0);

		m_pHeaderTextAlignHoriz = new ComboBox(m_pHeaderText, "HeaderTextAlignHorizontallyCombo", 3, false);
		kv = new KeyValues("AH");
		kv->SetInt("Left", ALIGN_LEFT);
		m_pHeaderTextAlignHoriz->AddItem("#GameUI_Left", kv);
		kv->deleteThis();
		kv = new KeyValues("AH");
		kv->SetInt("Center", ALIGN_CENTER);
		m_pHeaderTextAlignHoriz->AddItem("#GameUI_Center", kv);
		kv->deleteThis();
		kv = new KeyValues("AH");
		kv->SetInt("Right", ALIGN_RIGHT);
		...
		m_pHeaderIconSize->SetRange(1, QUANTITYITEMICONSIZES);
		...
		m_pTextSize->SetRange(1, QUANTITYPANELTEXTSIZES);
	...
	void CFFCustomHudPanelStylePresets::SetControlsEnabled(bool bEnabled)
	{
		...
		m_pPanelType->SetEnabled(bEnabled);
	...
	KeyValues* CFFCustomHudPanelStylePresets::RemoveNonEssentialValues(KeyValues* kvPreset)
	{
		...
		kvTemp->SetInt("panelType", kvPreset->GetInt("panelType", FFQuantityPanel::CORNERS_ROUND));
		kvTemp->SetInt("panelColorMode", kvPreset->GetInt("panelColorMode", COLOR_MODE_TEAM));
		...
		kvTemp->SetInt("headerTextAnchorPosition", kvPreset->GetInt("headerTextAnchorPosition", ANCHORPOS_TOPLEFT));
		kvTemp->SetInt("headerTextAlignHoriz", kvPreset->GetInt("headerTextAlignHoriz", ALIGN_LEFT));
		kvTemp->SetInt("headerTextAlignVert", kvPreset->GetInt("headerTextAlignVert", ALIGN_BOTTOM));
		kvTemp->SetInt("headerTextX", kvPreset->GetInt("headerTextX", 11));
		kvTemp->SetInt("headerTextY", kvPreset->GetInt("headerTextY", -4));
		kvTemp->SetInt("headerTextColorMode", kvPreset->GetInt("headerTextColorMode", COLOR_MODE_CUSTOM));
		...
		kvTemp->SetInt("headerIconAnchorPosition", kvPreset->GetInt("headerIconAnchorPosition", ANCHORPOS_TOPLEFT));
		kvTemp->SetInt("headerIconAlignHoriz", kvPreset->GetInt("headerIconAlignHoriz", ALIGN_LEFT));
		kvTemp->SetInt("headerIconAlignVert", kvPreset->GetInt("headerIconAlignVert", ALIGN_BOTTOM));
		kvTemp->SetInt("headerIconX", kvPreset->GetInt("headerIconX", -5));
		kvTemp->SetInt("headerIconY", kvPreset->GetInt("headerIconY", -2));
		kvTemp->SetInt("headerIconColorMode", kvPreset->GetInt("headerIconColorMode", COLOR_MODE_CUSTOM));
		...
		kvTemp->SetInt("textAnchorPosition", kvPreset->GetInt("textAnchorPosition", ANCHORPOS_TOPLEFT));
		kvTemp->SetInt("textAlignHoriz", kvPreset->GetInt("textAlignHoriz", ALIGN_LEFT));
		kvTemp->SetInt("textAlignVert", kvPreset->GetInt("textAlignVert", ALIGN_TOP));
		kvTemp->SetInt("textX", kvPreset->GetInt("textX", 5));
		kvTemp->SetInt("textY", kvPreset->GetInt("textY", 5));
		kvTemp->SetInt("textColorMode", kvPreset->GetInt("textColorMode", COLOR_MODE_CUSTOM));
	...
	void CFFCustomHudPanelStylePresets::UpdatePresetFromControls(KeyValues* kvPreset)
	{
		if (m_pHeaderTextAnchorPositionTopLeft->IsSelected())
			...
			kvPreset->SetInt("headerTextAnchorPosition", ANCHORPOS_TOPCENTER);
		else if (m_pHeaderTextAnchorPositionTopRight->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", ANCHORPOS_TOPRIGHT);
		else if (m_pHeaderTextAnchorPositionMiddleLeft->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", ANCHORPOS_MIDDLELEFT);
		else if (m_pHeaderTextAnchorPositionMiddleCenter->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", ANCHORPOS_MIDDLECENTER);
		else if (m_pHeaderTextAnchorPositionMiddleRight->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", ANCHORPOS_MIDDLERIGHT);
		else if (m_pHeaderTextAnchorPositionBottomLeft->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", ANCHORPOS_BOTTOMLEFT);
		else if (m_pHeaderTextAnchorPositionBottomCenter->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", ANCHORPOS_BOTTOMCENTER);
		else if (m_pHeaderTextAnchorPositionBottomRight->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", ANCHORPOS_BOTTOMRIGHT);
		...
		if (m_pHeaderIconAnchorPositionTopLeft->IsSelected())
			...
			kvPreset->SetInt("headerIconAnchorPosition", ANCHORPOS_TOPCENTER);
		else if (m_pHeaderIconAnchorPositionTopRight->IsSelected())
			kvPreset->SetInt("headerIconAnchorPosition", ANCHORPOS_TOPRIGHT);
			...
			kvPreset->SetInt("headerIconAnchorPosition", ANCHORPOS_MIDDLECENTER);
		else if (m_pHeaderIconAnchorPositionMiddleRight->IsSelected())
			kvPreset->SetInt("headerIconAnchorPosition", ANCHORPOS_MIDDLERIGHT);
		else if (m_pHeaderIconAnchorPositionBottomLeft->IsSelected())
			kvPreset->SetInt("headerIconAnchorPosition", ANCHORPOS_BOTTOMLEFT);
		else if (m_pHeaderIconAnchorPositionBottomCenter->IsSelected())
			kvPreset->SetInt("headerIconAnchorPosition", ANCHORPOS_BOTTOMCENTER);
		else if (m_pHeaderIconAnchorPositionBottomRight->IsSelected())
			kvPreset->SetInt("headerIconAnchorPosition", ANCHORPOS_BOTTOMRIGHT);
		...
		if (m_pTextAnchorPositionTopLeft->IsSelected())
			...
			kvPreset->SetInt("textAnchorPosition", ANCHORPOS_TOPCENTER);
		else if (m_pTextAnchorPositionTopRight->IsSelected())
			kvPreset->SetInt("textAnchorPosition", ANCHORPOS_TOPRIGHT);
		else if (m_pTextAnchorPositionMiddleLeft->IsSelected())
			kvPreset->SetInt("textAnchorPosition", ANCHORPOS_MIDDLELEFT);
		else if (m_pTextAnchorPositionMiddleCenter->IsSelected())
			kvPreset->SetInt("textAnchorPosition", ANCHORPOS_MIDDLECENTER);
		else if (m_pTextAnchorPositionMiddleRight->IsSelected())
			kvPreset->SetInt("textAnchorPosition", ANCHORPOS_MIDDLERIGHT);
		else if (m_pTextAnchorPositionBottomLeft->IsSelected())
			kvPreset->SetInt("textAnchorPosition", ANCHORPOS_BOTTOMLEFT);
		else if (m_pTextAnchorPositionBottomCenter->IsSelected())
			kvPreset->SetInt("textAnchorPosition", ANCHORPOS_BOTTOMCENTER);
		else if (m_pTextAnchorPositionBottomRight->IsSelected())
			kvPreset->SetInt("textAnchorPosition", ANCHORPOS_BOTTOMRIGHT);
		...
		kvPreset->SetInt("panelType", m_pPanelType->GetActiveItem() == 0 ? 2 : 0);
	...
	void CFFCustomHudPanelStylePresets::ApplyPresetToControls(KeyValues* kvPreset)
	{
		...
		m_pPanelType->RemoveActionSignalTarget(this);
		...
		m_pHeaderTextAnchorPositionTopLeft->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == ANCHORPOS_TOPLEFT);
		m_pHeaderTextAnchorPositionTopCenter->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == ANCHORPOS_TOPCENTER);
		m_pHeaderTextAnchorPositionTopRight->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == ANCHORPOS_TOPRIGHT);
		m_pHeaderTextAnchorPositionMiddleLeft->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == ANCHORPOS_MIDDLELEFT);
		m_pHeaderTextAnchorPositionMiddleCenter->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == ANCHORPOS_MIDDLECENTER);
		m_pHeaderTextAnchorPositionMiddleRight->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == ANCHORPOS_MIDDLERIGHT);
		m_pHeaderTextAnchorPositionBottomLeft->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == ANCHORPOS_BOTTOMLEFT);
		m_pHeaderTextAnchorPositionBottomCenter->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == ANCHORPOS_BOTTOMCENTER);
		m_pHeaderTextAnchorPositionBottomRight->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == ANCHORPOS_BOTTOMRIGHT);

		m_pHeaderIconAnchorPositionTopLeft->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == ANCHORPOS_TOPLEFT);
		m_pHeaderIconAnchorPositionTopCenter->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == ANCHORPOS_TOPCENTER);
		m_pHeaderIconAnchorPositionTopRight->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == ANCHORPOS_TOPRIGHT);
		m_pHeaderIconAnchorPositionMiddleLeft->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == ANCHORPOS_MIDDLELEFT);
		m_pHeaderIconAnchorPositionMiddleCenter->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == ANCHORPOS_MIDDLECENTER);
		m_pHeaderIconAnchorPositionMiddleRight->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == ANCHORPOS_MIDDLERIGHT);
		m_pHeaderIconAnchorPositionBottomLeft->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == ANCHORPOS_BOTTOMLEFT);
		m_pHeaderIconAnchorPositionBottomCenter->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == ANCHORPOS_BOTTOMCENTER);
		m_pHeaderIconAnchorPositionBottomRight->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == ANCHORPOS_BOTTOMRIGHT);

		m_pTextAnchorPositionTopLeft->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == ANCHORPOS_TOPLEFT);
		m_pTextAnchorPositionTopCenter->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == ANCHORPOS_TOPCENTER);
		m_pTextAnchorPositionTopRight->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == ANCHORPOS_TOPRIGHT);
		m_pTextAnchorPositionMiddleLeft->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == ANCHORPOS_MIDDLELEFT);
		m_pTextAnchorPositionMiddleCenter->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == ANCHORPOS_MIDDLECENTER);
		m_pTextAnchorPositionMiddleRight->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == ANCHORPOS_MIDDLERIGHT);
		m_pTextAnchorPositionBottomLeft->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == ANCHORPOS_BOTTOMLEFT);
		m_pTextAnchorPositionBottomCenter->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == ANCHORPOS_BOTTOMCENTER);
		m_pTextAnchorPositionBottomRight->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == ANCHORPOS_BOTTOMRIGHT);
		...
		m_pPanelType->ActivateItemByRow(kvPreset->GetInt("panelType", -1));
		...
		m_pPanelMargin->AddActionSignalTarget(this);
		m_pPanelType->AddActionSignalTarget(this);
	...
	{
		if (m_bLoaded
			&& (data->GetPtr("panel") == m_pPanelType
