...
#ifndef FF_SCOREBOARD_H
#define FF_SCOREBOARD_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class CFFClientScoreBoardDialog : public CClientScoreBoardDialog
{
private:
	DECLARE_CLASS_SIMPLE( CFFClientScoreBoardDialog, CClientScoreBoardDialog );
...
public:
	CFFClientScoreBoardDialog( IViewPort *pViewPort );
	~CFFClientScoreBoardDialog();
