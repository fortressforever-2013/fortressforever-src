...
ConVar hud_messages_duration("hud_messages_duration", "3", FCVAR_CLIENTDLL | FCVAR_ARCHIVE, "Default duration of FF messages on the HUD");
...
void CHudGameMessage::MsgFunc_GameMessage( bf_read &msg )
{
	...
	if( pszTemp )
		...
		g_pVGuiLocalize->ConvertANSIToUnicode( szString, messageMsg.pText, sizeof( messageMsg.pText ) );
