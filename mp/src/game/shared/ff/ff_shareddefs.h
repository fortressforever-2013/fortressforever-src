...
#define NEW_TEAM_COLOR_SPECTATOR Color( 204, 204, 204, 255 )
#define NEW_TEAM_COLOR_BLUE Color( 153, 204, 255, 255 )
#define NEW_TEAM_COLOR_RED Color( 255, 63, 63, 255 )
#define NEW_TEAM_COLOR_YELLOW Color( 255, 178, 0, 255 )
#define NEW_TEAM_COLOR_GREEN Color( 153, 255, 153, 255 )
