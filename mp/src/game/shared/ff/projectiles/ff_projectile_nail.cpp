...
//ConVar ffdev_nail_pushmultiplier("ffdev_nail_pushmultiplier", "0.7", FCVAR_FF_FFDEV_REPLICATED, "Nail pushforce multiplier - was 0.1 for 2.1 release") (SDK2013 calculates it in a different way);
#define FF_NAIL_PUSHMULTIPLIER 0.7f //ffdev_nail_pushmultiplier.GetFloat()
#define NAIL_SPEED 1800.0f //ffdev_nail_speed.GetFloat() //2000.0f and then 1000.0f and now 1800.0f because 1000 is way too slow
