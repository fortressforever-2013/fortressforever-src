...
CBaseEntity *CFFGameRules::GetPlayerSpawnSpot( CBasePlayer *pPlayer )
{
...
Vector CFFGameRules::GetPlayerSpawnSpotOffset(const CBasePlayer* pPlayer, const Vector vecOrigin, const Vector vecPlayerBoundsMins, const Vector vecPlayerBoundsMaxs)
{
