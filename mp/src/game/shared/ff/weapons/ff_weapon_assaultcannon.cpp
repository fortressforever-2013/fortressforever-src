...
#define FF_AC_MINCLAMPTIME 0.53f	// minimum charge on the AC before you can clamp
	...
	#define FF_AC_TRACERFREQ_CLIENT 3 // ffdev_ac_tracerfreq_client.GetInt()
#endif

//ConVar ffdev_ac_spread_min( "ffdev_ac_spread_min", "0.06", FCVAR_FF_FFDEV_REPLICATED, "The minimum cone of fire spread for the AC" );
#define FF_AC_SPREAD_MIN 0.08f // ffdev_ac_spread_min.GetFloat()
...
#define FF_AC_BULLET_DAMAGE	8.0f // ffdev_ac_bullet_damage.GetFloat()
...
#define FF_AC_ROF_MAX 0.05f // ac_rof_max.GetFloat()	// Assault Cannon maximum rate of fire
...
void CFFWeaponAssaultCannon::PrimaryAttack()
{
	...
	FireBulletsInfo_t info(iBulletsToFire * pWeaponInfo.m_iBullets, 
		...
		m_iPrimaryAmmoType);
	info.m_pAttacker = pPlayer;
	info.m_flDamage = (float) ((iBulletsToFire * pWeaponInfo.m_iBullets) * /*pWeaponInfo.m_iDamage*/FF_AC_BULLET_DAMAGE);
	info.m_flDamageForceScale = FF_AC_BULLETPUSH;
