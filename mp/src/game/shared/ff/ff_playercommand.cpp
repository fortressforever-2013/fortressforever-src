...
FF_AUTO_COMMAND( radar, &CFFPlayer::Command_Radar, "Quick Scan", FF_CMD_SKILL_COMMAND | FF_CMD_ALIVE | FF_CMD_PREMATCH );
...
FF_SHARED_COMMAND( offenseneedspy, &CFFPlayer::Command_NeedSpy, CC_NeedSpy, "Request a Spy", FF_CMD_NOFLAGS );
FF_SHARED_COMMAND( offensespotpipes, &CFFPlayer::Command_SpottedPipes, CC_SpottedPipes, "Warn about pipe traps", FF_CMD_NOFLAGS );
