...
//===========================
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_DRAW_WITH0);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DRAW_WITH1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DRAW_WITH2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DRAW_WITH3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DRAW_WITH4);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DRAW_WITH5);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DRAW_WITH6);

	REGISTER_SHARED_ACTIVITY(ACT_VM_SWITCHDRAW_WITH0);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SWITCHDRAW_WITH1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SWITCHDRAW_WITH2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SWITCHDRAW_WITH3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SWITCHDRAW_WITH4);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SWITCHDRAW_WITH5);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SWITCHDRAW_WITH6);

	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_WITH0);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_WITH1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_WITH2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_WITH3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_WITH4);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_WITH5);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_WITH6);

	REGISTER_SHARED_ACTIVITY(ACT_VM_DEEPIDLE_WITH0);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DEEPIDLE_WITH1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DEEPIDLE_WITH2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DEEPIDLE_WITH3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DEEPIDLE_WITH4);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DEEPIDLE_WITH5);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DEEPIDLE_WITH6);

	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_1TO0);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_2TO1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_3TO2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_4TO3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_5TO4);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_6TO5);

	REGISTER_SHARED_ACTIVITY(ACT_VM_STARTRELOAD_WITH0);
	REGISTER_SHARED_ACTIVITY(ACT_VM_STARTRELOAD_WITH1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_STARTRELOAD_WITH2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_STARTRELOAD_WITH3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_STARTRELOAD_WITH4);
	REGISTER_SHARED_ACTIVITY(ACT_VM_STARTRELOAD_WITH5);

	REGISTER_SHARED_ACTIVITY(ACT_VM_INITRELOAD_0TO1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_INITRELOAD_1TO2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_INITRELOAD_2TO3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_INITRELOAD_3TO4);
	REGISTER_SHARED_ACTIVITY(ACT_VM_INITRELOAD_4TO5);
	REGISTER_SHARED_ACTIVITY(ACT_VM_INITRELOAD_5TO6);

	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOAD_0TO1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOAD_1TO2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOAD_2TO3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOAD_3TO4);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOAD_4TO5);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOAD_5TO6);

	REGISTER_SHARED_ACTIVITY(ACT_VM_FINISHRELOAD_WITH1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_FINISHRELOAD_WITH2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_FINISHRELOAD_WITH3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_FINISHRELOAD_WITH4);
