...
#else	// --> Jon: cap swimming speed if cloaked
...
#ifndef FF	// Determine acceleration speed after acceleration
...
#ifndef FF
		return;
#else		// hlstriker: Make sure player isn't swimming before we return
