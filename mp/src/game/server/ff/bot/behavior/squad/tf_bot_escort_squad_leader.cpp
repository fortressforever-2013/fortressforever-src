...
// ff_bot_escort_squad_leader.cpp
...
ConVar ff_bot_squad_escort_range( "ff_bot_squad_escort_range", "500", FCVAR_CHEAT );
ConVar ff_bot_formation_debug( "ff_bot_formation_debug", "0", FCVAR_CHEAT );
...
ActionResult< CFFBot > CFFBotEscortSquadLeader::Update( CFFBot *me, float interval )
{
	...
	if ( ff_bot_formation_debug.GetBool() )
	{
