...
/////////////////////////////////////////////////////////////////////////////
bool CFFScriptManager::GetObject(CBaseEntity* pEntity, LuaRef& outObject)
{
...
/////////////////////////////////////////////////////////////////////////////
bool CFFScriptManager::GetObject(const char* szTableName, LuaRef& outObject)
{
	VPROF_BUDGET( "CFFScriptManager::GetObject", VPROF_BUDGETGROUP_FF_LUA );
	...
	try
	{
		...
		LuaRef retObject = getGlobal(L, szTableName);
		if(retObject.isTable())
		{
			outObject = retObject;
			return true;
		}
...
/////////////////////////////////////////////////////////////////////////////
bool CFFScriptManager::GetFunction(LuaRef& tableObject,
								  const char* szFunctionName,
								  LuaRef& outObject)
{
	VPROF_BUDGET( "CFFScriptManager::GetFunction", VPROF_BUDGETGROUP_FF_LUA );
	...
	try
	{
		LuaRef funcObject = tableObject[szFunctionName];
		if(funcObject.isFunction())
		{
